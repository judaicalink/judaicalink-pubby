...
//        }
        ...
        context.put(
                "project_link", config.getProjectLink());
        context.put(
                "uri", resource.getWebURI());
        context.put(
                "server_base", config.getWebApplicationBaseURI());
        context.put(
                "rdf_link", resource.getDataURL());
        context.put(
                "disco_link", discoLink);
        context.put(
                "graphite_link", graphiteLink);
        context.put(
                "sparql_endpoint", resource.getDataset().getDataSource().getEndpointURL());
        context.put(
                "title", title);
        context.put(
                "comment", comment);
        ...
        context.put(
                "showLabels", new Boolean(config.showLabels()));
        context.put(
                "sparql_query", getSPARQLQuery(resource));
        context.put("unicorn", new Boolean(request.getParameter("unicorn") != null));
